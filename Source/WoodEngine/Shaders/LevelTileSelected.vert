...
{	
	...
	v_worldPosition = vec3( u_position.x, u_height * u_size.x + 1*(cos(u_time * 3)*.25 + 1.25), u_position.y)  + vec3(v_localPosition.x, a_position.y * u_size.x, v_localPosition.y);
